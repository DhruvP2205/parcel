...
// used to build pairing codes. A 3-word code drawn without replacement from
// these 192 words has 192*191*190 ≈ 6,967,680 possible orderings. See
// generate.go and internal/discovery's PBKDF2-stretched beacon tag, which
// is the layer that actually has to resist offline guessing.
var wordlist = []string{
